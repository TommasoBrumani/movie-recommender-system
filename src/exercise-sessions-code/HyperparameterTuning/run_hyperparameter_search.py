    ...
    try:
        ...
        if recommender_class in [ItemKNN_CFCBF_Hybrid_Recommender, UserKNN_CFCBF_Hybrid_Recommender]:
            ...
            if recommender_class is ItemKNN_CFCBF_Hybrid_Recommender:
                hyperparameters_range_dictionary["ICM_weight"] = Real(low=1e-1, high=1e4, prior='log-uniform')
        ...
        elif recommender_class in [SideInfoRP3betaRecommender]:

            hyperparameters_range_dictionary = {
                "topK": Integer(5, 250),
                "alpha": Real(low=0.25, high=1.25, prior='uniform'),
        ...
        elif recommender_class in [S_SLIMElasticNet_Hybrid_Recommender]:

            hyperparameters_range_dictionary = {
                "topK": Integer(1000, 2000), # "topK": Integer(900, 1500),
                "l1_ratio": Real(5e-6, 5e-5, prior='log-uniform'), # "l1_ratio": Real(low=1e-5, high=1e-2, prior='log-uniform'),
                "alpha": Real(1e-2, 1e-1, prior="uniform"), # "alpha": Real(low=1e-2, high=1.0, prior='uniform'),
                "ICM_weight": Real(0.05, 0.5, prior="uniform"), # "ICM_weight": Real(low=1e-1, high=1e4, prior='log-uniform'),
            }
        ...
        elif recommender_class in [SideInfoIALSRecommender]:
            ...
            hyperparameters_range_dictionary = {
                ...
                "ICM_weight": Real(low=1e-1, high=1e3, prior='log-uniform'),
            }
